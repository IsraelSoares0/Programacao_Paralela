...
\texttt{gcc -O2 -o mxv mxv.c}, é apresentado no Código~\ref{lst:mxv}.

\lstinputlisting[style=cstyle, caption={Código-fonte \texttt{tarefa2.c} -- multiplicação matriz-vetor com dois padrões de acesso à memória.}, label={lst:mxv}]{../codigo/tarefa2.c}
